...
export declare class MergeStrategy extends BreezeEnum {
    ...
    **/
    static SkipMerge: MergeStrategy;
    /**
...
export declare class QueryOptions {
    ...
    **/
    ...
    static resolve(queryOptionsArray: any[]): QueryOptions;
    /**
    ...
    **/
    using(qoConfig: QueryOptionsConfig | MergeStrategy | FetchStrategy): QueryOptions;
    /**
    ...
    **/
    setAsDefault(): any;
    toJSON(): Object;
    static fromJSON(json: any): QueryOptions;
    /** @hidden @internal */
    private static _updateWithConfig;
}
