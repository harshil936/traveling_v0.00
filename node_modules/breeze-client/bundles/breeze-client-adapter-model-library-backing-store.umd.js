(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('breeze-client/adapter-model-library-backing-store', ['exports', 'breeze-client'], factory) :
    (global = global || self, factory((global['breeze-client'] = global['breeze-client'] || {}, global['breeze-client']['adapter-model-library-backing-store'] = {}), global['breeze-client']));
    ...
    var ModelLibraryBackingStoreAdapter = /** @class */ (function () {
        ...
        ModelLibraryBackingStoreAdapter.register = function (config$1) {
            config$1 = config$1 || breezeClient.config;
            config$1.registerAdapter("modelLibrary", ModelLibraryBackingStoreAdapter);
            return config$1.initializeAdapterInstance("modelLibrary", "backingStore", true);
        };
        ...
        ModelLibraryBackingStoreAdapter.prototype.startTracking = function (entity, proto) {
            ...
            var stype = breezeClient.EntityAspect.isEntity(entity) ? entity.entityType : entity.complexType;
            stype.getProperties().forEach(function (prop) {
                var propName = prop.name;
                var val = entity[propName];
                if (prop instanceof breezeClient.DataProperty) {
                    if (prop.isComplexProperty) {
                        if (prop.isScalar) {
                            val = prop.dataType._createInstanceCore(entity, prop);
                        }
                        else {
                            val = breezeClient.makeComplexArray([], entity, prop);
                        }
                    }
                    else if (!prop.isScalar) {
                        val = breezeClient.makePrimitiveArray([], entity, prop);
                    }
                    ...
                    if (prop.isScalar) {
                        ...
                        val = breezeClient.makeRelationArray([], entity, prop);
                    }
                }
                else {
    ...
    breezeClient.config.registerAdapter("modelLibrary", ModelLibraryBackingStoreAdapter);
    // private methods
    ...
    exports.ModelLibraryBackingStoreAdapter = ModelLibraryBackingStoreAdapter;

    Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=breeze-client-adapter-model-library-backing-store.umd.js.map
