(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('breeze-client/adapter-model-library-ko', ['exports', 'breeze-client'], factory) :
    (global = global || self, factory((global['breeze-client'] = global['breeze-client'] || {}, global['breeze-client']['adapter-model-library-ko'] = {}), global['breeze-client']));
    ...
    var ModelLibraryKnockoutAdapter = /** @class */ (function () {
        ...
        ModelLibraryKnockoutAdapter.register = function (config$1) {
    ...
    breezeClient.config.registerAdapter("modelLibrary", ModelLibraryKnockoutAdapter);
    // private fns
    ...
    function initializeValueForProp(entity, prop, val) {
        ...
        else if (prop instanceof breezeClient.NavigationProperty) {
            if (val !== undefined) {
    ...
    exports.ModelLibraryKnockoutAdapter = ModelLibraryKnockoutAdapter;

    Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=breeze-client-adapter-model-library-ko.umd.js.map
