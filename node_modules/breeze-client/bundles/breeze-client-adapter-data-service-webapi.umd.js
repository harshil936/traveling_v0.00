(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('breeze-client/adapter-data-service-webapi', ['exports', 'breeze-client'], factory) :
    (global = global || self, factory((global['breeze-client'] = global['breeze-client'] || {}, global['breeze-client']['adapter-data-service-webapi'] = {}), global['breeze-client']));
    ...
    ***************************************************************************** */
    ...
    var DataServiceWebApiAdapter = /** @class */ (function (_super) {
        ...
        function DataServiceWebApiAdapter() {
            ...
            _this.jsonResultsAdapter = new breezeClient.JsonResultsAdapter({
                ...
                visitNode: function (node, mappingContext, nodeContext) {
                    if (node == null)
                        return {};
                    var entityTypeName = breezeClient.MetadataStore.normalizeTypeName(node.$type);
        ...
        DataServiceWebApiAdapter.prototype._prepareSaveBundle = function (saveContext, saveBundle) {
            ...
            serSaveBundle.entities = saveBundle.entities.map(function (e, ix) {
                ...
                if (e.entityType.autoGeneratedKeyType !== breezeClient.AutoGeneratedKeyType.None) {
                    autoGeneratedKey = {
        ...
        DataServiceWebApiAdapter.prototype._prepareSaveResult = function (saveContext, data) {
            ...
            if (keyMappings.length) {
                ...
                keyMappings = keyMappings.map(function (km) {
                    ...
                    var kmHack = km;
                    var entityTypeName = breezeClient.MetadataStore.normalizeTypeName(kmHack.EntityTypeName);
            ...
            if (deletedKeys.length) {
                deletedKeys = deletedKeys.map(function (dk) {
                    ...
                    var entityTypeName = breezeClient.MetadataStore.normalizeTypeName(dk.EntityTypeName);
    ...
    breezeClient.config.registerAdapter("dataService", DataServiceWebApiAdapter);

    exports.DataServiceWebApiAdapter = DataServiceWebApiAdapter;

    Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=breeze-client-adapter-data-service-webapi.umd.js.map
