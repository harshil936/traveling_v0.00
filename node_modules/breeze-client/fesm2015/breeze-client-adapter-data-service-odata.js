import { core as core$1, AbstractDataServiceAdapter, JsonResultsAdapter, MetadataStore, config, AutoGeneratedKeyType, DataProperty, DataType } from 'breeze-client';

let core = core$1;
/** @hidden */
class DataServiceODataAdapter extends AbstractDataServiceAdapter {
    constructor() {
        super();
        ...
        this.jsonResultsAdapter = new JsonResultsAdapter({
            ...
            visitNode: function (node, mappingContext, nodeContext) {
                ...
                if (metadata != null) {
                    ...
                    let entityTypeName = MetadataStore.normalizeTypeName(metadata.type);
                        ...
                        if (rawEntity) {
                            ...
                            if (tempKey) {
                                ...
                                if (entityType.autoGeneratedKeyType !== AutoGeneratedKeyType.None) {
                                    ...
                                    let realKey = entityType.getEntityKeyFromRawEntity(rawEntity, DataProperty.getRawValueFromServer);
...
core$1.extend(webApiODataCtor.prototype, DataServiceODataAdapter.prototype);
config.registerAdapter("dataService", webApiODataCtor);
// OData 4 adapter
let webApiOData4Ctor = function () {
    this.name = "webApiOData4";
};
const ɵ1 = webApiOData4Ctor;
core$1.extend(webApiOData4Ctor.prototype, webApiODataCtor.prototype);
...
config.registerAdapter("dataService", webApiOData4Ctor);

/**
 * Generated bundle index. Do not edit.
 */

export { DataServiceODataAdapter, ɵ0, ɵ1 };
//# sourceMappingURL=breeze-client-adapter-data-service-odata.js.map
