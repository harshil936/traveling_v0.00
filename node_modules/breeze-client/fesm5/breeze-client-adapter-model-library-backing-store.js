import { core as core$1, config, EntityAspect, DataProperty, makeComplexArray, makePrimitiveArray, makeRelationArray } from 'breeze-client';
...
var ModelLibraryBackingStoreAdapter = /** @class */ (function () {
    ...
    ModelLibraryBackingStoreAdapter.prototype.startTracking = function (entity, proto) {
        ...
        var stype = EntityAspect.isEntity(entity) ? entity.entityType : entity.complexType;
...
//# sourceMappingURL=breeze-client-adapter-model-library-backing-store.js.map
